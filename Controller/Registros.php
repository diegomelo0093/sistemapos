  ...
  /* agregando y creando la imagen */
    if ($_FILES['userfile']['name'] != "") {
        ...
        if (!((strpos($tipo_archivo, "gif") || strpos($tipo_archivo, "jpeg") || strpos($tipo_archivo, "png")) && ($tamano_archivo < 5000000))) {
            cuadro_error("La extensión o el tamaño de los archivos no es correcta, Solo se permiten archivos .gif o .jpg de 5 Mb máximo");
        } else {
        ...
        $imagenUsuario = "fotoproducto/user.png";
    }
...
if (isset($_GET['idborrar'])){
    ...
    $delteUser = $con->deleteUsuario($idUsuario);
}
...
if (isset($_POST['update_usuario'])) {
    ...
    $mensaje = "Se Actualizo los datos de un  usuario";
...
/*redireccionamiento cuando se agrega un nuevo usuario*/
